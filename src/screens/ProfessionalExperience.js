    ...
    return (
        <div style={backgroundstyles}>
            ...
            {/* <CardHorizontal
                ...
                content={
                    <>
                        ...
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                                Supervisé y corregí errores en aplicaciones móviles para
                                asegurar un funcionamiento óptimo y una experiencia de usuario
                                de alta calidad.
                            </li>
                            <li className="list-group-item">
                                Implementé nuevas funciones y mejoras en aplicaciones móviles,
                            ...
                            <li className="list-group-item">
                                Participé en la revisión de código, asegurando el cumplimiento
                                de los estándares de calidad y buenas prácticas.
                            </li>
                            <li className="list-group-item">
                                Optimicé el rendimiento y la escalabilidad de las aplicaciones
                                mediante el análisis y la implementación de soluciones técnicas
                            ...
                            <li className="list-group-item">
                                Documenté y gestioné los procesos de desarrollo para asegurar un
                                flujo de trabajo eficiente, manteniendo comunicación con los
                                usuarios y stakeholders para recopilar feedback y definir
            ...
            <CardHorizontal
                ...
                cardText={
                    "Invecratos fue creada por iguz, esta empresa hizo un cambio de directiva que consigo trajo varios cambios, entre los principales se encuentra que se convertiria en lo que hasta la fecha de hoy es conocida como Inguz."
                }
                content={
                    <>
                        <p className="card-text">
                        ...
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                                Apoyé en la corrección de errores y mejoras de rendimiento en
                                las aplicaciones bajo la supervisión de desarrolladores senior,
                                participando en reuniones de planificación y revisión de código,
                                adquiriendo experiencia en el uso de GitHub para control de
                                versiones.
                            </li>
                            ...
                            <li className="list-group-item">
                                Implementé pruebas básicas de código utilizando ExpoGo para
                                asegurar la calidad del producto final y realicé documentación
                                de procesos, manteniendo reportes sobre el progreso de las
                                tareas asignadas.
                            </li>
                        </ul>
                    </>
